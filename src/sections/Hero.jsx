...
const [bigShoeImg, setbigShoeImg] = useState(bigShoe1)
  ...
  return (
    ...
    <p className="font-monstserrat text-slate-gray text-lg leading-8 mt-6 mb-14 sm:max-w-sm">Discover stylish Nike arrivals, quality comfort and innovation for your active life.</p>
